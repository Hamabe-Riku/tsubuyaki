...
import jp.kobe_u.cs.daikibo.tsubuyaki.dto.SearchForm;
import jp.kobe_u.cs.daikibo.tsubuyaki.dto.TsubuyakiForm;
// import jp.kobe_u.cs.daikibo.tsubuyaki.entity.Search;
...
public class TsubuyakiController {
    ...
    //つぶやきを検索
    @GetMapping("/search")
    String searchTsubuyaki(@RequestParam String keyword,@ModelAttribute(name = "searchForm") SearchForm form,Model model){
        List<Tsubuyaki> searchlist = ts.searchTsubuyaki(keyword);
